...
public static class ErrorMessages
{
    ...
    public const string ExpiredConfirmedAppointmentAutoCancelledReason = "Automatically cancelled because the scheduled date passed without the appointment being completed.";
    ...
    public const string VisitDateMustMatchAppointmentDate = "Visit date must match appointment date.";
    ...
    public const string PatientsCanCancelOnlyPendingAppointments = "Patients can cancel only pending appointments.";
    public const string DoctorsCanCancelOnlyPendingOrConfirmedAppointments = "Doctors can cancel only pending or confirmed appointments.";
}
