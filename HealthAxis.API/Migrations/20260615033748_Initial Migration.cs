    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@healthaxis.com", "System Admin", true, "Admin@123", "Admin" },
                    { 2, "anjali.menon@healthaxis.com", "Dr. Anjali Menon", true, "Doctor@123", "Doctor" },
                    { 3, "rahul.nair@healthaxis.com", "Dr. Rahul Nair", true, "Doctor@123", "Doctor" }
                });

            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "Id", "ConsultationFee", "ExperienceYears", "IsAvailable", "Specialisation", "UserId" },
                values: new object[,]
                {
                    { 1, 600m, 8, true, "Cardiology", 2 },
                    { 2, 500m, 5, true, "Dermatology", 3 }
                });
